...
We should be able to do this in a similar way to how we implemented the lever controls: have a function in Tank that fires the bullet, and a function in a Controller component elsewhere that calls that Tank function.
...
> [action]
>
Write a function that launches a bullet from the front of your Barrel. For now, make it controlled by a key press on our keyboard. To do this, you will want to create a Bullet Prefab that you can instantiate at some spawn point at the tip of your Barrel.
>
...
It's great and all that we can launch bullets, but right now they're kind of sad. They hit the ground and roll away all apathetic-like. We want them to explode!
...
> [action]
>
Drag `PyroParticles/Prefabs/Audio/FireExplosion5` into your `AudioSource`'s `AudioClip` slot.
>
...
> [challenge]
>
Now go ahead and try implementing another 3D sound in your scene. Give the button a sound when pressed, or the levers a looping sound when they move! Audio can really bring a VR experience that next step forward in terms of immersion!
